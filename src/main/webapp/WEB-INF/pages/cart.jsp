...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
        <div class="navbar-nav">
            ...
            <a href="settings" class="nav-item nav-link">Profile</a>
        </div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="row cart-row">
            ...
            <div class="col-xs-12 col-sm-2">
                <small>Total</small>
                <h3 class="h3-price">$${item.price.subtract(item.discount) * cart.getQuantity(item.id)}</h3>
            </div>

            <button onclick="location.href = 'cart/remove?ItemID=${item.id}'" class="btn btn-dark">
                Remove
            </button>
